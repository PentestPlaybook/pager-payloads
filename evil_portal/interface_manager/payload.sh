...
disable_interface() {
    ...
    uci show wireless.wlan0wpa.network 2>/dev/null | grep -q "evil" && WPA_EP=" (Evil Portal Enabled)"
    uci show wireless.wlan0open.network 2>/dev/null | grep -q "evil" && OPEN_EP=" (Evil Portal Enabled)"
